               ...
               <div className={`relative flex flex-col w-[100px] h-[100px] justify-center items-center `}>
                                   ...
                                   <div className={`flex flex-col justify-center items-center mt-3 `}>
                                       <span className={`w-full leading-customLH text-[24px] font-medium text-center`}>
                                               به <small className='faNumber text-[24px] text-primary400 font-extrabold '> برنامه  </small> خوش آمدید!
                                           </span>
                ...
                <div className={`relative w-full h-[40px] mt-[35px] flex justify-center items-center select-none `} onClick={() => clickHandler()}>
                    ...
                    <small className='absolute text-white text-lg cursor-pointer' >ارسال کد</small>
                </div>
                    <Link href={'/userpasslogin'}>
                        <a className='mt-[40px] text-sm font-semibold text-gray-600 select-none'>ورود با<small className='text-[15px] mr-2 text-Base'>رمز عبور و نام کاربری</small></a>
                    </Link>
                </div>
        </div>
        {/* Left Parent----------------------------- */}
