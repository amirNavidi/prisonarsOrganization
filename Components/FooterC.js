    ...
    return (
        <div>
            <div className="w-full hidden lg:flex flex-wrap justify-between items-end  lg:px-[120px] h-[380px] pb-12 bg-primary50 ">
                    <div className="flex flex-col items-start w-4/12 bg-transparent text-[16px] ">
                 ...
                 <div className='w-full border-t border-primary100 pt-7 text-secondary600'>
                    طراحی و توسعه داده شده در <a target='_blank' href='https://sepandbi.com/' className='text-primary500'>سپند</a>. تمام حقوق اين وب‌سايت متعلق به سازمان زندان ها میباشید.
                 </div>
            </div>
